...
export const outDir = Path.join(Path.resolve(__dirname, '../../../client/src/app/api'));
export const defsDir = 'defs';
export const apiDir = 'controllers';
export const storeDir = 'store';
export const stateDir = 'states';
export const apiFile =Path.join(Path.resolve(__dirname, '../../../web-server/swagger-auth.json')); 
